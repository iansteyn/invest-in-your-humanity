Note: turn on word-wrap when you view this.
...
The sample that I built everything on is the sound of my friend Andrew typing on a computer keyboard. I took it from a video I made to present my group's final design project back when I was an engineering student in April 2022 (https://youtu.be/ZD-uVNHXyZ8). At the time, we all agreed it was a very satisfying sound and it really stuck in my memory. 
